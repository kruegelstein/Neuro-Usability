...
export const submitResults = (id, name, level, time1, time2, time3, time4, time5, selectedLetters1, selectedLetters2, selectedLetters3, selectedLetters4, selectedLetters5, letter1, letter2, letter3, letter4, letter5, einfach, hässlich, praktisch, stilvoll, voraussagbar, minderwertig, phantasielos, gut, verwirrend, lahm) => ({
  type: ActionTypes.Submit,  payload: { id, name, level, time1, time2, time3, time4, time5, selectedLetters1, selectedLetters2, selectedLetters3, selectedLetters4, selectedLetters5, letter1, letter2, letter3, letter4, letter5, einfach, hässlich, praktisch, stilvoll, voraussagbar, minderwertig, phantasielos, gut, verwirrend, lahm } })
